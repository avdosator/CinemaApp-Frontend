...
export default function SignUpForm() {
    const { register, handleSubmit, setError, formState: { errors, isSubmitting }, watch } = useForm<SignupFormType>();
    ...
    const getIconColor = (value: string): string => (value ? "#B22222" : "#344054");
            ...
            <form className="sign-up-form" onSubmit={handleSubmit(onSubmit)} >
                <div id="sign-up-email-container" className="sign-up-input-group">
                    ...
                    <div className="sign-up-input-wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" className="input-icon" fill={getIconColor(emailValue)} viewBox="0 0 512 512"><path d="M64 112c-8.8 0-16 7.2-16 16l0 22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1l0-22.1c0-8.8-7.2-16-16-16L64 112zM48 212.2L48 384c0 8.8 7.2 16 16 16l384 0c8.8 0 16-7.2 16-16l0-171.8L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64l384 0c35.3 0 64 28.7 64 64l0 256c0 35.3-28.7 64-64 64L64 448c-35.3 0-64-28.7-64-64L0 128z" /></svg>
                        <input
                            {...register("email", {
                ...
                <div id="sign-up-password-container" className="sign-up-input-group">
                    ...
                    <div className="sign-up-input-wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" className="input-icon" fill={getIconColor(passwordValue)} viewBox="0 0 448 512"><path d="M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" /></svg>
                        <input
                            {...register("password", {
                ...
                <div id="sign-up-confirm-password-container" className="sign-up-input-group">
                    ...
                    <div className="sign-up-input-wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" className="input-icon" fill={getIconColor(confirmPasswordValue)} viewBox="0 0 448 512"><path d="M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" /></svg>
                        <input
