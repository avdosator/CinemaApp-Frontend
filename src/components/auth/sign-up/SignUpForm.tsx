    ...
    return (
        <div className="sign-up-form-container">
            ...
            <form className="sign-up-form" onSubmit={handleSubmit(onSubmit)} >
                <div id="sign-up-email-container" className={`sign-up-input-group ${getContainerClass(emailValue, !!errors.email)}`}>
                ...
                <div id="sign-up-password-container" className={`sign-up-input-group ${getContainerClass(passwordValue, !!errors.password)}`}>
                ...
                <div id="sign-up-confirm-password-container" className={`sign-up-input-group ${getContainerClass(confirmPasswordValue, !!errors.confirmPassword)}`}>
